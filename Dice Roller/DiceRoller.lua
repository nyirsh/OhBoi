        ...
        <HorizontalLayout id="panelID" childAlignment="MiddleCenter">
          <VerticalLayout>
            <GridLayout cellSize="60 40" childAlignment="MiddleCenter">
              <Button onClick="]] .. guid ..
                             [[/spawnKill(1)" colors="#282C34|#b50f00|#C8C8C8|rgba(0.78,0.78,0.78,0.5)"><Text fontStyle="bold" fontSize="30" color="#CCCCCC">1D</Text></Button>
              <Button onClick="]] .. guid ..
                             [[/spawnKill(2)" colors="#282C34|#b50f00|#C8C8C8|rgba(0.78,0.78,0.78,0.5)"><Text fontStyle="bold" fontSize="30" color="#CCCCCC">2D</Text></Button>
              <Button onClick="]] .. guid ..
                             [[/spawnKill(3)" colors="#282C34|#b50f00|#C8C8C8|rgba(0.78,0.78,0.78,0.5)"><Text fontStyle="bold" fontSize="30" color="#CCCCCC">3D</Text></Button>
            </GridLayout>
            <GridLayout cellSize="60 40" childAlignment="MiddleCenter">
              <Button onClick="]] .. guid ..
                             [[/spawnKill(4)" colors="#282C34|#b50f00|#C8C8C8|rgba(0.78,0.78,0.78,0.5)"><Text fontStyle="bold" fontSize="30" color="#CCCCCC">4D</Text></Button>
              <Button onClick="]] .. guid ..
                             [[/spawnKill(5)" colors="#282C34|#b50f00|#C8C8C8|rgba(0.78,0.78,0.78,0.5)"><Text fontStyle="bold" fontSize="30" color="#CCCCCC">5D</Text></Button>
              <Button onClick="]] .. guid ..
                             [[/spawnKill(6)" colors="#282C34|#b50f00|#C8C8C8|rgba(0.78,0.78,0.78,0.5)"><Text fontStyle="bold" fontSize="30" color="#CCCCCC">6D</Text></Button>
            </GridLayout>
          </VerticalLayout>
          <Button onClick="]] .. guid ..
                             [[/roll()" colors="#282C34|#b50f00|#C8C8C8|rgba(0.78,0.78,0.78,0.5)" minWidth="80"><Text fontStyle="bold" fontSize="30" color="#CCCCCC">ROLL</Text></Button>
          <VerticalLayout>
            <GridLayout cellSize="60 40" childAlignment="MiddleCenter">
              <Button onClick="]] .. guid ..
                             [[/selectValueP(0)" colors="#282C34|#b50f00|#C8C8C8|rgba(0.78,0.78,0.78,0.5)"><Text fontStyle="bold" fontSize="25" color="#CCCCCC">Low</Text></Button>
              <Button onClick="]] .. guid ..
                             [[/selectValueP(1)" colors="#282C34|#b50f00|#C8C8C8|rgba(0.78,0.78,0.78,0.5)"><Text fontStyle="bold" fontSize="30" color="#CCCCCC">1</Text></Button>
              <Button onClick="]] .. guid ..
                             [[/selectValueP(2)" colors="#282C34|#b50f00|#C8C8C8|rgba(0.78,0.78,0.78,0.5)"><Text fontStyle="bold" fontSize="30" color="#CCCCCC">2-</Text></Button>
            </GridLayout>
            <GridLayout cellSize="60 40" childAlignment="MiddleCenter">
              <Button onClick="]] .. guid ..
                             [[/selectValueP(3)" colors="#282C34|#b50f00|#C8C8C8|rgba(0.78,0.78,0.78,0.5)"><Text fontStyle="bold" fontSize="30" color="#CCCCCC">3-</Text></Button>
              <Button onClick="]] .. guid ..
                             [[/selectValueP(4)" colors="#282C34|#b50f00|#C8C8C8|rgba(0.78,0.78,0.78,0.5)"><Text fontStyle="bold" fontSize="30" color="#CCCCCC">4-</Text></Button>
              <Button onClick="]] .. guid ..
                             [[/selectValueP(5)" colors="#282C34|#b50f00|#C8C8C8|rgba(0.78,0.78,0.78,0.5)"><Text fontStyle="bold" fontSize="30" color="#CCCCCC">5-</Text></Button>
            </GridLayout>
          </VerticalLayout>
        </HorizontalLayout>
      </Panel>
      <Panel id="diceZoomUI" color="rgba(0.2,0.2,0.2,0.7)" position="-900 0 -20" rotation="0 0 0"
        ...
        <Panel height="280" width="100" childAlignment="MiddleCenter">
          <HorizontalLayout childAlignment="MiddleCenter">
            ...
            <VerticalLayout>
              <Button onClick="]] .. guid ..
                             [[/selectValue(1)" colors="#282C34|#b50f00|#C8C8C8|rgba(0.78,0.78,0.78,0.5)"><Text fontStyle="bold" fontSize="25" color="#CCCCCC">1</Text></Button>
              <Button onClick="]] .. guid ..
                             [[/selectValue(2)" colors="#282C34|#b50f00|#C8C8C8|rgba(0.78,0.78,0.78,0.5)"><Text fontStyle="bold" fontSize="25" color="#CCCCCC">2</Text></Button>
              <Button onClick="]] .. guid ..
                             [[/selectValue(3)" colors="#282C34|#b50f00|#C8C8C8|rgba(0.78,0.78,0.78,0.5)"><Text fontStyle="bold" fontSize="25" color="#CCCCCC">3</Text></Button>
              <Button onClick="]] .. guid ..
                             [[/selectValue(4)" colors="#282C34|#b50f00|#C8C8C8|rgba(0.78,0.78,0.78,0.5)"><Text fontStyle="bold" fontSize="25" color="#CCCCCC">4</Text></Button>
              <Button onClick="]] .. guid ..
                             [[/selectValue(5)" colors="#282C34|#b50f00|#C8C8C8|rgba(0.78,0.78,0.78,0.5)"><Text fontStyle="bold" fontSize="25" color="#CCCCCC">5</Text></Button>
              <Button onClick="]] .. guid ..
                             [[/selectValue(6)" colors="#282C34|#b50f00|#C8C8C8|rgba(0.78,0.78,0.78,0.5)"><Text fontStyle="bold" fontSize="25" color="#CCCCCC">6</Text></Button>
...
function isPlayerAllowed(player, func)
    ...
    if retValue == false then
        player.broadcast("Hey [" .. getColorHex(player.color) .. "]" .. player.steam_name .. "[-]! Only [" ..
                             getColorHex(leftColor) .. "]" .. leftColor .. "[-] and [" .. getColorHex(rightColor) .. "]" ..
                             rightColor .. "[-] players can use the roller!")
    end
    return retValue
end
...
function askSpawn(args)
    ...
    if isPlayerAllowed(player, 'askSpawn') == false then
        return
    end
...
function spawnKill(player, number, autoRoll)
    if isPlayerAllowed(player, 'spawnKill') == false then
        return
    end
        ...
        if dice6Image == '' then
            spawnParams = {
                ...
                callback_function = function(obj)
                    spawn_callback(obj, player, autoRoll, dice6Image, false, key)
                end
            }
        else
            spawnParams = {
                ...
                snap_to_grid = false,
                callback_function = function(obj)
                    spawn_callback(obj, player, autoRoll, dice6Image, true, key)
                end
            }
        end
...
function spawn_callback(obj, player, autoRoll, diceImage, custom, key)
    if isPlayerAllowed(player, 'spawn_callback') == false then
        return
    end
    local newobj
...
function regroup(player)
    if isPlayerAllowed(player, 'regroup') == false then
        return
    end
    local buff = true
    local offset = 4.8
    ...
    for key, value in pairs(getGrid(getDiceNumber(player), -1, -1, 2 * size, offset)) do
        if player.color == leftColor then
            diceTabL[key].setRotation({
                x = diceTabL[key].getRotation().x,
                y = self.getRotation().y,
                z = diceTabL[key].getRotation().z
            })
            if diceTabL[key].setPositionSmooth(value, false, true) == false then
                buff = false
            end
        else
            diceTabR[key].setRotation({
                x = diceTabR[key].getRotation().x,
                y = self.getRotation().y,
                z = diceTabR[key].getRotation().z
            })
...
function fixValue(player)
    if isPlayerAllowed(player, 'fixValue') == false then
        return
    end
...
function deleteDice(obj, player)
    if isPlayerAllowed(player, 'deleteDice') == false then
        return
    end
...
function getDiceNumber(player)
    if isPlayerAllowed(player, 'getDiceNumber') == false then
        return
    end
...
function roll(player)
    if isPlayerAllowed(player, 'roll') == false then
        return
    end
...
function order(player)
    if isPlayerAllowed(player, 'order') == false then
        return
    end
    fixValue(player)
    ...
    for diceValue = 1, 6, 1 do
        ...
        for key, value in pairs(diceTabTemp) do
            diceTabTemp[key].setRotation({
                x = diceTabTemp[key].getRotation().x,
                y = self.getRotation().y,
                z = diceTabTemp[key].getRotation().z
            })
            local p = -count - 2
...
function selectValueP(player, valueDice)
    if isPlayerAllowed(player, 'selectValueP') == false then
        return
    end
...
function selectValue(player, valueDice)
    if isPlayerAllowed(player, 'selectValue') == false then
        return
    end
    player.clearSelectedObjects()
...
function destroyValueP(player, valueDice)
    if isPlayerAllowed(player, 'destroyValueP') == false then
        return
    end
...
function selectAll(player)
    if isPlayerAllowed(player, 'selectAll') == false then
        return
    end
    player.clearSelectedObjects()
...
function toggleMenu(player, value, id)
    if isPlayerAllowed(player, 'toggleMenu') == false then
        return
    end
...
function toggleUI(player)
    if isPlayerAllowed(player, 'toggleUI') == false then
        return
    end
    local side = "Left"
    if player.color == rightColor then
